...
public class EndangeredDescriptionsAdapter extends RecyclerView.Adapter<EndangeredDescriptionsAdapter.DescriptionViewHolder>{
    private List<String> descriptions;

    public EndangeredDescriptionsAdapter(List<String> descriptions) {
